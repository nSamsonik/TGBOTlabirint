...
width, height = 750, 750  # Размер окна
tile = 50  # Размер ячейки

cols = (width // tile + 1) // 2  # width // tile - кол-во столбцов. Кол-во столбцов белых клеток - width // tile + 1 / 2
rows = (height // tile + 1) // 2  # Количество строк

pygame.init()
screen = pygame.display.set_mode((width, height))
pygame.display.set_caption("Labirint game")
